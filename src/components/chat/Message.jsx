...
// import { Check, CheckCheck, MoreHorizontal, Reply, Trash2 } from "lucide-react";

// import { reactToMessage, deleteMessage } from "@/services/chatApi";

// import { getSocket, connectSocket } from "@/socket/socket";

// const reactionEmojis = ["❤️", "😂", "😮", "😢", "👍", "🔥"];

// export default function Message({ message, onReply, onReaction }) {
...
//     if (reacting || deleting || !message.id) {
//       return;
//     }
...
//       // --------------------------------------------------
//       // Delete immediately from current UI
//       // --------------------------------------------------
...
//   return (
//     <div className={`message-row ${isMe ? "message-me" : "message-other"}`}>
...
//             <button
//               type="button"
//               onClick={() => setShowReactions((previous) => !previous)}
